...
$string ['print'] = 'Print';
$string ['privacy:gradepath'] = 'grade_{$a}';
$string ['privacy:metadata:vpl'] = 'Information of the activity';
$string ['privacy:metadata:vpl_evaluations'] = 'Information of the evaluation';
$string ['privacy:metadata:vpl_submissions'] = 'Information of the attempt/submission';
