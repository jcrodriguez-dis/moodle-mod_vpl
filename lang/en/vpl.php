...
$string['basedon_missed'] = 'Based-on "{$a}" was missed by restoring/importing';
$string['basedon_chain_broken'] = 'Error: Chain of based-on activities broken';
$string['basedon_deleted'] = 'Error: Based-on missed, the activity was deleted?';
$string['basic'] = 'Basic';
