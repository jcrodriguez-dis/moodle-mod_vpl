...
$string['requiresafeexambrowser_help'] = 'If enabled, students can only access this VPL activity using Safe Exam Browser.';
...
$string['enablesebsession'] = 'Use unique SEB configuration per session';
...
$string['privacy:metadata:vpl_seb:adminpassword'] = 'Administrator password used to protect SEB settings.';
