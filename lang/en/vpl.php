...
$string['activateurlfiltering'] = 'Enable URL filtering';
...
$string['allowcapturecamera'] = 'Allow browser access to camera';
$string['allowcapturemicrophone'] = 'Allow browser access to microphone';
$string['allowreloadinexam'] = 'Enable reload in exam';
$string['allowspellchecking'] = 'Enable spell checking';
$string['allowuserquitseb'] = 'Enable quitting of SEB';
...
$string['downloadsafeexambrowser'] = 'Download Safe Exam Browser';
$string['downloadsebconfig'] = 'Download Safe Exam Browser configuration';
...
$string['enableaudiocontrol'] = 'Enable audio controls';
$string['enablesebsession'] = 'Use unique SEB configuration per user';
...
$string['eventsebaccessdenied'] = 'SEB access denied';
$string['eventsebwrongkey'] = 'SEB wrong key';
...
$string['expressionsallowed'] = 'Allowed URL expressions';
$string['expressionsblocked'] = 'Blocked URL expressions';
$string['file'] = 'File';
...
$string['filterembeddedcontent'] = 'Filter embedded content';
...
$string['launchsafeexambrowser'] = 'Launch Safe Exam Browser';
$string['linkquitseb'] = 'Quit link';
...
$string['muteonstartup'] = 'Mute on startup';
...
$string['preventsebsimultaneoussessions'] = 'Prevent simultaneous SEB sessions';
...
$string['privacy:metadata:vpl_seb'] = 'Safe Exam Browser settings for a VPL activity.';
$string['privacy:metadata:vpl_seb:activateurlfiltering'] = 'Whether URL filtering is enabled.';
$string['privacy:metadata:vpl_seb:allowcapturecamera'] = 'Whether the browser may access the camera.';
$string['privacy:metadata:vpl_seb:allowcapturemicrophone'] = 'Whether the browser may access the microphone.';
$string['privacy:metadata:vpl_seb:allowreloadinexam'] = 'Whether reloading is allowed during the exam.';
$string['privacy:metadata:vpl_seb:allowspellchecking'] = 'Whether spell checking is enabled.';
$string['privacy:metadata:vpl_seb:allowuserquitseb'] = 'Whether the user is allowed to quit Safe Exam Browser.';
$string['privacy:metadata:vpl_seb:enableaudiocontrol'] = 'Whether the audio controls are enabled.';
$string['privacy:metadata:vpl_seb:enablesebsession'] = 'Whether unique SEB configurations per session are enabled.';
$string['privacy:metadata:vpl_seb:expressionsallowed'] = 'The allowed URL expressions.';
$string['privacy:metadata:vpl_seb:expressionsblocked'] = 'The blocked URL expressions.';
$string['privacy:metadata:vpl_seb:filterembeddedcontent'] = 'Whether embedded content is filtered.';
$string['privacy:metadata:vpl_seb:linkquitseb'] = 'The URL used to quit Safe Exam Browser.';
$string['privacy:metadata:vpl_seb:muteonstartup'] = 'Whether the audio is muted on startup.';
$string['privacy:metadata:vpl_seb:preventsebsimultaneoussessions'] = 'Whether simultaneous SEB sessions are prevented.';
$string['privacy:metadata:vpl_seb:quitpassword'] = 'The password required to quit Safe Exam Browser.';
$string['privacy:metadata:vpl_seb:regexallowed'] = 'The allowed URL regular expressions.';
$string['privacy:metadata:vpl_seb:regexblocked'] = 'The blocked URL regular expressions.';
$string['privacy:metadata:vpl_seb:sebteacherpassword'] = 'Teacher password for SEB session exceptions.';
$string['privacy:metadata:vpl_seb:showkeyboardlayout'] = 'Whether the keyboard layout is shown.';
$string['privacy:metadata:vpl_seb:showreloadbutton'] = 'Whether the reload button is shown.';
$string['privacy:metadata:vpl_seb:showsebdownloadlink'] = 'Whether the Safe Exam Browser download button is shown.';
$string['privacy:metadata:vpl_seb:showsebtaskbar'] = 'Whether the Safe Exam Browser task bar is shown.';
$string['privacy:metadata:vpl_seb:showtime'] = 'Whether the time is shown.';
$string['privacy:metadata:vpl_seb:showwificontrol'] = 'Whether the Wi-Fi control is shown.';
$string['privacy:metadata:vpl_seb:timecreated'] = 'The date the settings were created.';
$string['privacy:metadata:vpl_seb:timemodified'] = 'The date the settings were last modified.';
$string['privacy:metadata:vpl_seb:userconfirmquit'] = 'Whether the user must confirm quitting.';
$string['privacy:metadata:vpl_seb:usermodified'] = 'The id of the user that last modified the settings.';
$string['privacy:metadata:vpl_seb:vplid'] = 'The VPL activity id.';
$string['privacy:metadata:vpl_seb_session'] = 'Per-user SEB session keys for a VPL activity.';
$string['privacy:metadata:vpl_seb_session:configkey1'] = 'The first SEB configuration key.';
$string['privacy:metadata:vpl_seb_session:configkey2'] = 'The final SEB configuration key.';
$string['privacy:metadata:vpl_seb_session:sesskey'] = 'The Moodle session key linked to the final SEB configuration.';
$string['privacy:metadata:vpl_seb_session:token1private'] = 'The private token embedded in the first SEB configuration.';
$string['privacy:metadata:vpl_seb_session:token1public'] = 'The public token used to download the first SEB configuration.';
$string['privacy:metadata:vpl_seb_session:token2private'] = 'The private token embedded in the final SEB configuration.';
$string['privacy:metadata:vpl_seb_session:userid'] = 'The user id.';
$string['privacy:metadata:vpl_seb_session:vplid'] = 'The VPL activity id.';
...
$string['regexallowed'] = 'Allowed URL regular expression';
$string['regexblocked'] = 'Blocked URL regular expression';
...
$string['sebkeys_help'] = 'SEB exam key(s) (max 3) obtained from .seb file<br>The confiuration files are created using Seb Configuration Tool.<br>https://safeexambrowser.org';
$string['sebkeys_pass'] = 'Your SEB browser is <b>using</b> the expected configuration';
$string['sebrequired'] = 'Require the use of Safe Exam Browser';
$string['sebrequired_bad'] = 'It looks like you are <b>not using</b> SEB browser';
$string['sebrequired_help'] = 'If enabled, students can only access the VPL activity using the Safe Exam Browser.
The available options are:
* No <br/>Safe Exam Browser is not required to access.
...
$string['showkeyboardlayout'] = 'Show keyboard layout';
$string['showparentfiles'] = 'Show parent files';
$string['showreloadbutton'] = 'Show reload button';
$string['showsebdownloadlink'] = 'Show Safe Exam Browser download button';
$string['showsebtaskbar'] = 'Show SEB task bar';
$string['showtime'] = 'Show time';
$string['showwificontrol'] = 'Show Wi-Fi control';
...
$string['userconfirmquit'] = 'Ask user to confirm quitting';
