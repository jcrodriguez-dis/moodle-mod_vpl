...
<h1>Comprovar servidors pres&oacute;</h1>
<p>Aquesta p&agrave;gina comprova i mostra l'estat dels servidors pres&oacute; utilitzats per aquesta activitat.</p>
END_OF_HELP;
$string['executionfiles_help'] = <<<'END_OF_HELP'
<h1>Fitxers executables</h1>
<h2>Introducci&oacute;</h2>
<p>Aqu&iacute; s'estableixen els fitxers necessaris per l'execuci&oacute;, depurat o avaluaci&oacute; d'un lliurament .
...
<h1>Opcions d'execuci&oacute;</h1>
...
<h1>Descripci&oacute; completa</h1>
...
<h1>Laboratori Virtual de Programaci&oacute;</h1>
<ul>
  <li><a href="help.php?module=vpl&amp;file=mods.html">B&agrave;sic</a></li>
  <li><a href="help.php?module=vpl&amp;file=fulldescription.html">Descripci&oacute; completa</a></li>
  <li><a href="help.php?module=vpl&amp;file=variations.html">Variacions</a></li>
  <li><a href="help.php?module=vpl&amp;file=requestedfiles.html">Fitxers requerits</a></li>
  <li>Execuci&oacute;
  <ul>
  <li><a href="help.php?module=vpl&amp;file=executionfiles.html">Fitxers executables</a></li>
  <li><a href="help.php?module=vpl&amp;file=executionoptions.html">Opcions d'execuci&oacute;</a></li>
  <li><a href="help.php?module=vpl&amp;file=resourcelimits.html">L&iacute;mit de recursos d'execuci&oacute;</a></li>
  <li><a href="help.php?module=vpl&amp;file=keepfiles.html">Fitxers a mantenir mentre s'executa</a></li>
  </ul></li>
</ul>
END_OF_HELP;
$string['keepfiles_help'] = <<<'END_OF_HELP'
<h1>Fitxers a mantenir durant l'execuci&oacute;</h1>
...
<h1>Servidors pres&oacute; locals</h1>
...
<p><img alt="VPL" src="<?php echo $CFG->wwwroot?>/mod/vpl/icon.gif" />&nbsp;<b>VPL. Laboratori Virtual de Programaci&oacute;</b></p>
...
<h1>L&iacute;mit de recursos d'execuci&oacute;</h1>
...
<p>Cada variaci&oacute; t&eacute; un codi d'identificaci&oacute; i una descripci&oacute;. L'identificador s'usa en el fitxer <b>vpl_enviroment.sh</b> per passar la variaci&oacute; assignada a l'estudiant a los scripts. La descripci&oacute;, amb format HTML, es mostra als estudiants als que ha estat assignada la variaci&oacute; corresponent.</p>
END_OF_HELP;
?>
