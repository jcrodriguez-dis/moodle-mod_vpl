...
$string['case_sensitive']= 'Sensible a mayúsculas y minúsculas';
...
$string['contextual_help']= 'Ayuda contextual';
$string['copy']= 'Copiar';
$string['copy_text']= 'Copiar el texto seleccionado';
$string['create_new_file']= 'Crea un nuevo fichero para editar';
$string['currentstatus']='Estado actual';
$string['cut']= 'Cortar';
$string['cut_text']= 'Cortar el texto seleccionado';
...
$string['diff'] = 'diff';
$string['direct_applet']='Despliegue directo del applet';
$string['direct_applet_description']='Se usan etiquetas HTML para desplegar applet. Establezca esta opción si los clientes no tienen acceso a www.java.com';
...
$string['find']= 'Buscar';
$string['find_find_replace']= 'Buscar o Buscar y Reemplazar texto';
$string['find_next_search_string']= 'Buscar siguiente en el texto';
$string['find_replace']= 'Buscar/Reemplazar';
$string['font_size']= 'Tamaño de letra';
$string['fulldescription'] = 'Descripción completa';
$string['fullscreen'] = 'Pantalla completa';
$string['general_help'] = "Ayuda general sobre el lenguaje";
$string['go_next_page']= 'Ir a la siguiente página';
...
$string['page_unaccessible']= 'Página inaccesible';
$string['paste']= 'Pegar';
$string['paste_text']= 'Pegar el texto seleccionado';
...
$string['select_all_text']= 'Seleccionar todo el texto';
...
$string['toggle_show_line_number']= 'Mostrar número de línea';
$string['totalnumberoferrors']="Errores";
$string['undo']= 'Deshacer';
$string['undo_change']= 'Deshacer cambios';
