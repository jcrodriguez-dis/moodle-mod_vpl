...
$string['activateurlfiltering'] = 'Activar el filtrado de URL';
...
$string['allowcapturecamera'] = 'Permitir al navegador acceder a la cámara';
$string['allowcapturemicrophone'] = 'Permitir al navegador acceder al micrófono';
$string['allowreloadinexam'] = 'Permitir recargar durante el examen';
$string['allowspellchecking'] = 'Activar la corrección ortográfica';
$string['allowuserquitseb'] = 'Permitir salir de SEB';
...
$string['checkseb'] = 'Comprobar Safe Exam Browser';
...
$string['downloadsafeexambrowser'] = 'Descargar Safe Exam Browser';
$string['downloadsebconfig'] = 'Descargar configuracion de Safe Exam Browser';
...
$string['enableaudiocontrol'] = 'Activar los controles de audio';
$string['enablesebsession'] = 'Usar una configuración SEB única por usuario';
...
$string['eventsebaccessdenied'] = 'Acceso SEB denegado';
...
$string['expressionsallowed'] = 'Expresiones de URL permitidas';
$string['expressionsblocked'] = 'Expresiones de URL bloqueadas';
$string['file'] = 'Fichero';
...
$string['filterembeddedcontent'] = 'Filtrar el contenido incrustado';
...
$string['launchsafeexambrowser'] = 'Lanzar Safe Exam Browser';
$string['linkquitseb'] = 'Enlace de salida';
...
$string['muteonstartup'] = 'Silenciar al iniciar';
...
$string['preventsebsimultaneoussessions'] = 'Impedir sesiones SEB simultáneas';
...
$string['privacy:metadata:vpl_seb'] = 'Configuración de Safe Exam Browser de una actividad VPL.';
$string['privacy:metadata:vpl_seb:activateurlfiltering'] = 'Si se activa el filtrado de URL.';
$string['privacy:metadata:vpl_seb:allowcapturecamera'] = 'Si el navegador puede acceder a la cámara.';
$string['privacy:metadata:vpl_seb:allowcapturemicrophone'] = 'Si el navegador puede acceder al micrófono.';
$string['privacy:metadata:vpl_seb:allowreloadinexam'] = 'Si se permite recargar durante el examen.';
$string['privacy:metadata:vpl_seb:allowspellchecking'] = 'Si se activa la corrección ortográfica.';
$string['privacy:metadata:vpl_seb:allowuserquitseb'] = 'Si se permite al usuario salir de Safe Exam Browser.';
$string['privacy:metadata:vpl_seb:enableaudiocontrol'] = 'Si se activan los controles de audio.';
$string['privacy:metadata:vpl_seb:enablesebsession'] = 'Si se usa una configuración SEB única por sesión.';
$string['privacy:metadata:vpl_seb:expressionsallowed'] = 'Expresiones de URL permitidas.';
$string['privacy:metadata:vpl_seb:expressionsblocked'] = 'Expresiones de URL bloqueadas.';
$string['privacy:metadata:vpl_seb:filterembeddedcontent'] = 'Si se filtra el contenido incrustado.';
$string['privacy:metadata:vpl_seb:linkquitseb'] = 'URL usada para salir de Safe Exam Browser.';
$string['privacy:metadata:vpl_seb:muteonstartup'] = 'Si se silencia el audio al iniciar.';
$string['privacy:metadata:vpl_seb:preventsebsimultaneoussessions'] = 'Si se impiden las sesiones SEB simultáneas.';
$string['privacy:metadata:vpl_seb:quitpassword'] = 'Clave necesaria para salir de Safe Exam Browser.';
$string['privacy:metadata:vpl_seb:regexallowed'] = 'Expresiones regulares de URL permitidas.';
$string['privacy:metadata:vpl_seb:regexblocked'] = 'Expresiones regulares de URL bloqueadas.';
$string['privacy:metadata:vpl_seb:sebteacherpassword'] = 'Clave de profesor para excepciones de sesión SEB.';
$string['privacy:metadata:vpl_seb:showkeyboardlayout'] = 'Si se muestra la distribución del teclado.';
$string['privacy:metadata:vpl_seb:showreloadbutton'] = 'Si se muestra el botón de recarga.';
$string['privacy:metadata:vpl_seb:showsebdownloadlink'] = 'Si se muestra el botón de descarga de Safe Exam Browser.';
$string['privacy:metadata:vpl_seb:showsebtaskbar'] = 'Si se muestra la barra de tareas de SEB.';
$string['privacy:metadata:vpl_seb:showtime'] = 'Si se muestra la hora.';
$string['privacy:metadata:vpl_seb:showwificontrol'] = 'Si se muestra el control de Wi-Fi.';
$string['privacy:metadata:vpl_seb:timecreated'] = 'Fecha de creación de la configuración.';
$string['privacy:metadata:vpl_seb:timemodified'] = 'Fecha de la última modificación de la configuración.';
$string['privacy:metadata:vpl_seb:userconfirmquit'] = 'Si el usuario debe confirmar la salida.';
$string['privacy:metadata:vpl_seb:usermodified'] = 'ID del último usuario que modificó la configuración.';
$string['privacy:metadata:vpl_seb:vplid'] = 'ID de VPL en la base de datos';
$string['privacy:metadata:vpl_seb_session'] = 'Claves de sesión SEB por usuario de una actividad VPL.';
$string['privacy:metadata:vpl_seb_session:configkey1'] = 'Clave de la primera configuración SEB.';
$string['privacy:metadata:vpl_seb_session:configkey2'] = 'Clave de la configuración SEB final.';
$string['privacy:metadata:vpl_seb_session:sesskey'] = 'Clave de sesión de Moodle vinculada a la configuración SEB final.';
$string['privacy:metadata:vpl_seb_session:token1private'] = 'Token privado incluido en la primera configuración SEB.';
$string['privacy:metadata:vpl_seb_session:token1public'] = 'Token público usado para descargar la primera configuración SEB.';
$string['privacy:metadata:vpl_seb_session:token2private'] = 'Token privado incluido en la configuración SEB final.';
$string['privacy:metadata:vpl_seb_session:userid'] = 'ID del usuario en la base de datos.';
$string['privacy:metadata:vpl_seb_session:vplid'] = 'ID de VPL en la base de datos';
...
$string['regexallowed'] = 'Expresión regular de URL permitida';
$string['regexblocked'] = 'Expresión regular de URL bloqueada';
...
$string['seb_configuremanually'] = 'Sí - Configurar manualmente';
$string['seb_useclientconfig'] = 'Sí - Usar la configuración del cliente SEB';
$string['sebinvalidteacherpassword'] = 'La clave del profesor no es válida.';
...
$string['sebrequired'] = 'Requerir el uso de Safe Exam Browser';
$string['sebrequired_bad'] = 'Parece que <b>no está usando</b> el navegador SEB';
$string['sebrequired_help'] = 'Si se activa, los estudiantes solo pueden acceder a la actividad VPL usando Safe Exam Browser.
Las opciones disponibles son:
* No <br/>No se requiere Safe Exam Browser para acceder.
...
$string['sebsessionwarning'] = 'Actualmente existen sesiones SEB para esta actividad. Al cambiar la configuración de SEB se eliminarán todas las sesiones actuales.';
...
$string['showkeyboardlayout'] = 'Mostrar la distribución del teclado';
$string['showparentfiles'] = 'Mostrar ficheros padre';
$string['showreloadbutton'] = 'Mostrar el botón de recarga';
$string['showsebdownloadlink'] = 'Mostrar el botón de descarga de Safe Exam Browser';
$string['showsebtaskbar'] = 'Mostrar la barra de tareas de SEB';
$string['showtime'] = 'Mostrar la hora';
$string['showwificontrol'] = 'Mostrar el control de Wi-Fi';
...
$string['userconfirmquit'] = 'Pedir al usuario que confirme la salida';
