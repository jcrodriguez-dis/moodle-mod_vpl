...
$string['sebinvalidteacherpassword'] = 'La clave del profesor no es valida.';
$string['sebsimultaneoussessionblocked'] = 'Ya hay otra sesion SEB activa para esta actividad. Introduzca la clave del profesor para reemplazarla.';
$string['sebteacherpassword'] = 'Clave de profesor para excepciones de sesion SEB';
