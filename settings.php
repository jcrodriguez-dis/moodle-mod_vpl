...
$listmaxexefilesize = vpl_get_select_sizes( 16 * $megabyte ); // Start value.
$listmaxexememory = vpl_get_select_sizes( 16 * $megabyte ); // Start value.
...
$defaultdefaultexememory = vpl_get_array_key( $listmaxexememory, 64 * $megabyte );
...
$settings->add( new admin_setting_configselect( $prefix . 'maxfilesize', get_string( 'maxfilesize', VPL )
               , get_string( 'maxfilesize', VPL ), $defaultmaxfilesize, $listmaxfilesize ) );
$settings->add( new admin_setting_configselect( $prefix . 'maxexetime', get_string( 'maxexetime', VPL )
               , get_string( 'maxexetime', VPL ), $defaultmaxtime, $listmaxtime ) );
...
$settings->add( new admin_setting_configselect( $prefix . 'maxexememory', get_string( 'maxexememory', VPL )
               , get_string( 'maxexememory', VPL ), $defaultmaxexememory, $listmaxexememory ) );
...
$settings->add( new admin_setting_configselect( $prefix . $name, get_string( $name, VPL )
                , get_string( $name, VPL ), $defaultdefaultfilesize, $listmaxfilesize ) );
$name = 'defaultexetime';
$settings->add( new admin_setting_configselect( $prefix . $name, get_string( $name, VPL )
                , get_string( $name, VPL ), $defaultdefaulttime, $listmaxtime ) );
$name = 'defaultexefilesize';
$settings->add( new admin_setting_configselect( $prefix . $name, get_string( $name, VPL )
                , get_string( $name, VPL ), $defaultdefaultexefilesize, $listmaxexefilesize ) );
$name = 'defaultexememory';
$settings->add( new admin_setting_configselect( $prefix . $name, get_string( $name, VPL )
                , get_string( $name, VPL ), $defaultdefaultexememory, $listmaxexememory ) );
$name = 'defaultexeprocesses';
$settings->add( new admin_setting_configtext( $prefix . $name, get_string( $name, VPL )
                , get_string( $name, VPL ), $defaultdefaultexeprocesses, PARAM_INT, 4 ) );
...
$settings->add( new admin_setting_configtextarea( $prefix . 'jail_servers', get_string( 'jail_servers', VPL )
                , get_string( 'jail_servers_description', VPL ), $default ) );
$settings->add( new admin_setting_configcheckbox( $prefix . 'acceptcertificates'
                , get_string( 'acceptcertificates', VPL ), get_string( 'acceptcertificates_description', VPL ), 1 ) );
$wsoptions = array (
...
$settings->add( new admin_setting_configselect( $prefix . 'websocket_protocol', get_string( 'websocket_protocol', VPL )
