...
/**
 * Class for logging submission grade delete events
 *
 * @package mod_vpl
...
/**
 * Event class for when a submission grade is deleted.
 * This class is used to log the event when a grade for a submission is deleted in the VPL module.
 */
