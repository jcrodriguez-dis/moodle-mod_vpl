...
/**
 * Class for logging of execution local jails view events
 *
 * @package mod_vpl
...
/**
 * Event class for when local jails are viewed.
 * This class is used to log the event when the local jails form is viewed.
 */
