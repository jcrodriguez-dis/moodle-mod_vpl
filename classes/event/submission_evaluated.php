...
/**
 * Class for logging submission evaluate events
 *
 * @package mod_vpl
...
/**
 * Event class for when a submission is evaluated.
 * This class is used to log the event when a submission is evaluated in the VPL module.
 */
