...
/**
 * Class for logging of execution limits update events
 *
 * @package mod_vpl
...
/**
 * Event class for when execution limits are updated.
 * This class is used to log the event when the execution limits form is submitted.
 */
class vpl_execution_limits_updated extends vpl_base {
    ...
    protected function init() {
        parent::init();
        $this->legacyaction = 'execution save limits';
    }
