...
/**
 * Class for logging of variation related events
 *
 * @package mod_vpl
...
/**
 * Event class for when a variation is updated.
 * This class is used to log the event when a variation configuration is updated.
 */
