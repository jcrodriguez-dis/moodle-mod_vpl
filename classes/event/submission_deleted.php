...
/**
 * Class for logging submission edit events
 *
 * @package mod_vpl
...
/**
 * Event class for when a submission is deleted.
 * This class is used to log the event when a submission is deleted in the VPL module.
 */
