...
class vpl_tokenizer_c extends vpl_tokenizer_base {
    /**
     * @var int REGULAR State not recognizing any special token.
     */
    const REGULAR = 0;

    /**
     * @var int IN_STRING State for recognizing string literals.
     */
    const IN_STRING = 1;

    /**
     * @var int IN_CHAR State for recognizing character literals.
     */
    const IN_CHAR = 2;

    /**
     * @var int IN_MACRO State for recognizing preprocessor macros.
     */
    const IN_MACRO = 3;

    /**
     * @var int IN_LINECOMMENT State for recognizing line comments.
     */
    const IN_COMMENT = 4;
    ...
    /**
     * @var int IN_NUMBER State for recognizing numbers.
     */
    const IN_NUMBER = 6;

    /**
     * @var array $creserved Reserved keywords for the C programming language.
     */
     ...
     *
     * Initializes the reserved keywords for the C programming language.
     */
