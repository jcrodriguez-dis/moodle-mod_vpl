<?php
/**
 * @package mod_vpl. mod_vpl_webservice class
 ...
 */
	...
	public static function info_returns(){
		return new external_single_structure(array(
			...
			'reqfiles' => new external_multiple_structure(
	...
	/*
	 * save function.
	* save/submit the students files
	*/
	...
	/*
	 * open function.
	* return the student's submitted files
	*/
	...
	*/
	...
	public static function evaluate_returns(){
		$desc = <<<END_OF_DESC
URL to the service that monitor the evaluation in the jail server.
