...
# @vpl_script_description Using GCC C ANSI standard with math and util libs
...
# Compile
eval gcc -ansi -pedantic -fno-diagnostics-color -o vpl_execution $2 @.vpl_source_files -lm -lutil 
rm .vpl_source_files
